...
<div class="card">
    ...
    <div class="card-body">
        <?php if (!empty($items)): ?>
            <table class="table table-hover">
                ...
                <?php foreach ($items as $item): ?>
                    <tr data-id="<?php echo $item['id'] ?>"
                        ...
                        <td>
                            <input type="number" min="1" class="form-control item-quantity" style="width:70px"
            ...
            <div class="card-body">
                <a href="<?php echo \yii\helpers\Url::to(['/cart/checkout']) ?>" class="btn btn-primary btn-sm"
                   style="margin-left:1060px !important;">Checkout</a>
            </div>
        <?php else: ?>
